...
// document.body.children[1].firstElementChild.lastElementChild // any other option?

// var selectSection = document.body.children[1];
// var para = document.createElement("p");
// var node = document.createTextNode('Hello')
// para.appendChild(node);
// var text = para.appendChild(node);
// selectSection.appendChild(text);

// var footerClass = document.body.children[2]; // best way to select?
// footerClass.classList.add("main");
// footerClass.classList.remove("main");

// var li = document.createElement('li');
// li.innerText = "four";
// var ul = document.body.children[1].firstElementChild;
// ul.appendChild(li);

// var ol = document.body.children[1].lastElementChild.children;
...
// var logPosition = document.getElementById('position');

// function positionDisplay (event) {
// 	logPosition.innerText =
// 	`The ScreenX position is = ${event.screenX}
// 	The ScreenY position is = ${event.screenY}
// 	The ClientX position is = ${event.clientX}
// 	The ClientY position is= ${event.clientY}`
// }

// document.addEventListener("mousemove", positionDisplay);